from servicos import modulo_clientes, modulo_produtos, modulo_pedidos, modulo_login_adm
...
def interface_hamburgueria_admin(opc: int, usuario):
    try:
        CONTADOR = 0
        while CONTADOR != 1:
            if (opc < 1 or opc > 3):
                ...
                print ("==========")
                opc2 = int(input("Digite o que deseja gerenciar \n1 - Cadastrar login \n2 - Excluir Login \n3 - Sair \nEscolha: "))
                local = modulo_login_adm.inteface_logins(opc2)
            
            elif (opc == 2):
                print ("==========")
                opc2 = int(input("Digite o que deseja gerenciar \n1 - Clientes \n2 - Produtos \n3 - Pedidos \n4 - Sair \nEscolha: "))
                interface_hamburgueria(opc2, usuario)
